...
public class SimplifiedOdometryRobot {
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("FRONTLEFT_DRIVE", DcMotor.Direction.FORWARD);
        rightFrontDrive = setupDriveMotor("FRONTRIGHT_DRIVE", DcMotor.Direction.REVERSE);
        leftBackDrive  = setupDriveMotor( "BACKLEFT_DRIVE", DcMotor.Direction.REVERSE);
        rightBackDrive = setupDriveMotor( "BACKRIGHT_DRIVE",DcMotor.Direction.REVERSE);
