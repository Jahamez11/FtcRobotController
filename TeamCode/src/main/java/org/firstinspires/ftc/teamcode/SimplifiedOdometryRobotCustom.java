...
public class SimplifiedOdometryRobotCustom {
    ...
    private static final double DRIVE_ACCEL         = 30.0;     // Acceleration limit.  Percent Power change per second.  1.0 = 0-100% power in 1 sec.
    private static final double DRIVE_TOLERANCE     = 2;//0.5;     // Controller is is "inPosition" if position error is < +/- this amount
    private static final double DRIVE_DEADBAND      = 0.1;//0.2;     // Error less than this causes zero output.  Must be smaller than DRIVE_TOLERANCE
    ...
    private static final double STRAFE_ACCEL        = 30.0;     // Acceleration limit.  Percent Power change per second.  1.0 = 0-100% power in 1 sec.
    private static final double STRAFE_TOLERANCE    = 2;//0.2;     // Controller is is "inPosition" if position error is < +/- this amount
    private static final double STRAFE_DEADBAND     = 0.1;//0.2;     // Error less than this causes zero output.  Must be smaller than DRIVE_TOLERANCE
    ...
    private static final double YAW_ACCEL           = 45.0;     // Acceleration limit.  Percent Power change per second.  1.0 = 0-100% power in 1 sec.
    private static final double YAW_TOLERANCE       = 2;//1.0;     // Controller is is "inPosition" if position error is < +/- this amount
    private static final double YAW_DEADBAND        = 0.1;//0.25;    // Error less than this causes zero output.  Must be smaller than DRIVE_TOLERANCE
    private static final double YAW_MAX_AUTO        = 1;     // "default" Maximum Yaw power limit during autonomous
