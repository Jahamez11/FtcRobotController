...
//    odometry = new SimplifiedOdometryRobotCustom(this, backleft, frontleft);
        ...
        while (opModeIsActive()) {
            launcherSpoll();
            odometry.drive(-TTAutoConstants.BACKUP_TO_SHOOT2, TTAutoConstants.DRIVE_POWER, 0);
...
//      sleep(1000);
            ...
            odometry.strafe(TTAutoConstants.STRAFE_GROUP_4, TTAutoConstants.DRIVE_POWER, 0);
            //    sleep(1000);
            ...
            // Step 4: Strafe left to ball group
            odometry.strafe(TTAutoConstants.STRAFE_GROUP_5, TTAutoConstants.DRIVE_POWER, 0);

            // Step 5: Drive forward while collecting balls
            pickupBalls();
            driveAndCollect(TTAutoConstants.COLLECT_GROUP_3, TTAutoConstants.DRIVE_POWER_COLLECT);
            // Step 6: Back up to shooting lane
